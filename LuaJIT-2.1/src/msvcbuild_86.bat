...
@set LJLINK=link /nologo /LIBPATH:../../libs/ lua_shared_lib_32.lib
@set LJMT=mt /nologo
...
@set ALL_LIB=lib_base.c lib_math.c lib_bit.c lib_string.c lib_table.c lib_io.c lib_os.c lib_package.c lib_debug.c lib_jit.c lib_ffi.c lib_buffer.c gmod.c
