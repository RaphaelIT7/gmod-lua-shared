...
private:
	...
	char _8[1];
	char _9[39];
	GarrysMod::Lua::ILuaObject* m_pWeaponMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pVectorMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pAngleMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pPhysObjMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pISaveMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pIRestoreMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCTakeDamageInfoMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCEffectDataMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCMoveDataMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCRecipientFilterMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCUserCmd = nullptr;
	GarrysMod::Lua::ILuaObject* m_unknown1 = nullptr; // Probably only Menu state
	GarrysMod::Lua::ILuaObject* m_pIMaterialMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pPanelMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCLuaParticleMeta = nullptr;
	char _10[3];
	GarrysMod::Lua::ILuaObject* m_pITextureMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pBf_readMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pConVarMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pIMeshMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pVMatrixMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCSoundPatchMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pPixelvis_handle_tMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pDlight_tMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pIVideoWriterMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pFileMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCLuaLocomotionMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pPathFollowerMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCNavAreaMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pIGModAudioChannelMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCNavLadderMeta = nullptr;
	GarrysMod::Lua::ILuaObject* m_pCNewParticleEffectMeta = nullptr;
